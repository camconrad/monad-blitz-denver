...
export default function CoachPage() {
  ...
  return (
    <div className="h-dvh flex flex-col overflow-hidden">
      {/* Header */}
      <header className="border-b border-border card-glass">
          ...
          <div className="flex-1 lg:flex-[0.45] flex flex-col gap-2">
            <div className="flex-1 relative rounded-2xl overflow-hidden flex items-center justify-center min-h-[320px]">
              ...
              <div className="relative z-10 text-center px-6 pt-36">
                ...
                <Button
                  size="lg"
                  variant={isActive ? 'outline' : 'primarySubtle'}
                  onClick={() => setIsActive(!isActive)}
                  className={
                    isActive
                      ? 'rounded-full px-10 py-6 text-sm font-medium border-destructive/40 text-destructive hover:bg-destructive/10 hover:border-destructive/60 transition-colors'
      ...
      {/* Footer */}
      <footer className="border-t border-border card-glass px-3 py-2 w-full">
